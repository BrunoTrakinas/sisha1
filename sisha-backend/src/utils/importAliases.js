const FIELD_ALIASES = {
  ...
  nsn: ['nsn', 'nsn/pi', 'nsn-pi', 'nato ref', 'nato reference', 'nato stock number'],
  pi: ['pi'],
  nomenclatura: ['nomenclatura', 'description', 'descrição', 'descricao', 'nome portugues', 'nome_portugues', 'incoming part desc'],
  qtd: ['qtd', 'qty', 'qte', 'qtde', 'quantidade', 'quantity', 'reqd qty', 'required qty', 'required'],
  localizacao: ['localizacao', 'localização', 'local', 'loc', 'location'],
  ...
  moq: ['moq'],
  price: ['price', 'unit price', 'unit value', 'valor unitario', 'valor_unitário', 'valor_unitario'],
  ...
  in_shipment: ['in shipment', 'in delivery'],
  delivered: ['delivered'],
